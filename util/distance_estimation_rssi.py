...
if __name__ == '__main__':
    ...
    path_loss_exp = 2.0
    d_ref = 1.0
    d_est, d_min, d_max = estimate_distance(current_rssi, (d_ref, power_ref, path_loss_exp, stdev_power))
    print("Current RSSI: ", current_rssi)
    print("Power Reference at 1m: ", power_ref)
    print("Standard Deviation of current power: ", stdev_power)
