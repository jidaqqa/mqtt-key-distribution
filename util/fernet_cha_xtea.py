...
class FernetXtea:
    ...
    def _encrypt_from_parts(
        ...
        encryptor = new(self._encryption_key, mode=MODE_OFB, IV=iv)
    ...
    def decrypt(
        ...
        timestamp, data = FernetXtea._get_unverified_token_data(token)
        if ttl is None:
            time_info = None
        else:
    ...
    def _decrypt_data(
        ...
        decryptor = new(self._encryption_key, mode=MODE_OFB, IV=iv)
...
class MultiFernet:
    def __init__(self, fernets: typing.Iterable[FernetXtea]):
    ...
    def rotate(self, msg: typing.Union[bytes, str]) -> bytes:
        timestamp, data = FernetXtea._get_unverified_token_data(msg)
